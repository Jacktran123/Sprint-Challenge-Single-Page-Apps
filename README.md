...
> Answer:
 Client-side routing render different component based on the URL, this is faster than Server-side routing in case the bandwidth is slow, it makes the site transits between pages faster. 
